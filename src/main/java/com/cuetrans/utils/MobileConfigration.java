...
public class MobileConfigration {


	public static String[][] getMobileConfig(String sheetName) throws IOException {
		String[][] data = null;
		int i, j;
		String cellValue = "";
		...
		try {
			...
			XSSFSheet wSheet = wBook.getSheet("MobileProperties");
